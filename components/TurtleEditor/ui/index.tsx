...
export default function UserInterface(props: any) {
  ...
  const handleEditorDidMount = (editor: any) => {
    ...
    editor.onDidChangeModelContent((value) => {
      autosaveHandler(c, value);
    });
  };
  ...
  return (
    ...
    >
      <div className="row">
        <div className="monacoeditor panel relative" ref={c.editorPanelRef}>
          <Editor
            // height="90vh"
        ...
        <div className="graphicspanel panel" ref={c.graphicspanelRef}>
          <div
            ...
            onMouseDown={(e) => grabCanvasHandler(e, c, setPosition)}
            style={{
              position: "absolute",
              top: position.top,
              left: position.left,
