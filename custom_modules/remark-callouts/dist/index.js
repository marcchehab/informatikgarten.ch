...
var callouts = function callouts(providedConfig) {
  ...
  return function (tree) {
    visit(tree, function (node, index, parent) {
      var _m$groups, _m$groups2, _m$groups3, _parsedSvg, _blockquote$children$;
      ...
      var paragraph = blockquote.children[0];
      if (paragraph.children.length <= 0 || paragraph.children[0].type !== "text") return;
      var _paragraph$children = _toArray(paragraph.children),
        t = _paragraph$children[0],
        rest = _paragraph$children.slice(1);
      var regex = new RegExp("^\\[!(?<keyword>(.*?))\\](?<foldChar>[+-]?)[\t\f ]?(?<title>.*?)$", "gi");
      var m = regex.exec(t.value);
      ...
      var key = (_m$groups = m.groups) === null || _m$groups === void 0 ? void 0 : _m$groups.keyword,
        ...
        title = (_m$groups3 = m.groups) === null || _m$groups3 === void 0 ? void 0 : _m$groups3.title;
      ...
      if (title) {
        var mdast = fromMarkdown(title.trim()).children[0];
        if (mdast.type === "heading") {
          mdast.data = _objectSpread2(_objectSpread2({}, mdast.data), {}, {
            hProperties: {
              className: "blockquote-heading"
            }
          });
        }
        blockquote.children.unshift(mdast);
      } else {
...
export { callouts, callouts as default, defaultConfig };
